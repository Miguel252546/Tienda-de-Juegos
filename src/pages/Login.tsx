  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto bg-white dark:bg-gamer-charcoal rounded-lg p-8 border border-gray-200 dark:border-gamer-gray transition-colors">
          <h1 className="text-3xl font-gamer font-bold text-blue-600 dark:text-neon-blue mb-8 text-center">
          ...
          <form onSubmit={isLogin ? handleLogin : handleRegister} className="space-y-6">
            ...
            <div>
              <label className="block text-gray-900 dark:text-white font-semibold mb-2">{t('common.password')}</label>
              <input
                type="password"
                name="password"
          ...
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-gray-200 dark:border-gamer-gray" />
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-gamer-charcoal text-gray-600 dark:text-gray-400">o</span>
              </div>
            </div>
            <button
              onClick={handleGuest}
              className="w-full mt-4 bg-transparent border-2 border-blue-600 dark:border-neon-blue text-blue-600 dark:text-neon-blue py-3 rounded-lg font-semibold hover:bg-blue-600 dark:hover:bg-neon-blue hover:text-white transition-colors"
            >
          ...
          <div className="mt-6 text-center">
            <Link to="/" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-neon-blue transition-colors">
              Volver al inicio
            </Link>
          </div>
        </div>
